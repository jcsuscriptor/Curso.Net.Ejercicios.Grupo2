        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ISBN = table.Column<string>(type: "TEXT", nullable: false),
                    Publicacion = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Genero = table.Column<string>(type: "TEXT", nullable: true),
                    Cantidad = table.Column<long>(type: "INTEGER", nullable: true),
